...
**DO NOT use for:**
- Analyzing single branch (use branch-status instead)
- Comparing two branches (use compare-branches instead)
- General iteration review on current branch (use review-progress instead)
