...
**DO NOT use for:**
- Ending the iteration (use end-iteration instead)
- Starting iteration (use start-iteration instead)
...
- **Beginning State** section (from start-iteration)
- **Iteration Intention** section (from start-iteration)
- **Work Performed** section (may be partially filled from previous checkpoint, or empty)
- **Ending State** section (will be empty - that's for end-iteration)
- **Iteration Metadata** section (will be empty - that's for end-iteration)
...
- Final assessment (that's for end-iteration)
