...
The journal file was created by start-iteration. Now complete it:
...
2. **Read existing journal:**
   ...
   Journal will have:
   - Beginning State (from start-iteration)
   - Iteration Intention (from start-iteration)
...
The journal file was created by start-iteration with:
...
| Mistake | Reality |
|---------|---------|
| "I'll create new journal file instead of updating existing" | NO. Journal was created by start-iteration. Update it with Edit tool. |
