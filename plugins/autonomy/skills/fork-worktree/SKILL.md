...
**DO NOT use for:**
- Creating branches without worktrees (use fork-iteration instead)
- Creating non-autonomy branches (use git directly)
- Starting iterations (use start-iteration instead)
...
Determine what commit to fork from (same logic as fork-iteration):
